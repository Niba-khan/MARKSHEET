...
if (rollNum == 12345) {
    ...
    let urdu = marks.Urdu;
    let islamiat = marks.Islamiat;
    let math = marks.Math;
    let biology = marks.Biology;
    let chemistry = marks.Chemistry;
    let physics = marks.Physics;
    //Percentage:
    let totalMarks = 700;
    let obtainMarks = english + urdu + islamiat + math + biology + chemistry + physics;
